...
The slope and intercept are of course 1 and 0 because it's been standardized and normalized. Using the same formula on the unadjusted plot shows the fit

```{r unadjusted-plot}
ex71svdUnadjusted <- svd(ex7data1)
ggplot(as.data.frame(ex7data1), aes(V1, V2)) +
    geom_point() +
    geom_abline(slope = ex71svdUnadjusted$v[2,1]/ex71svdUnadjusted$v[1,1], intercept = )
...
We should expect to see (-0.707, -0.707).
